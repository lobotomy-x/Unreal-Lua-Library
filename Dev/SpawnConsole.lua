        ...
        local pc_player_ref = pc.Player
            if not pc_player_ref then
                ...
                while props ~= nil do
                    ...
                    if props and props.get_fname and props:get_fname():to_string():equals("player", true) then
            ...
            if pc_player_ref then
                ...
                _viewport = ("GameViewportClient"):get_first_object_matching(false)
            end

            if _viewport and _viewport.ViewportConsole == nil then
                   local console_class = find_fast("Console")

             local temp = api:spawn_object(console_class, _viewport)
